<footer class="border-t border-[var(--border)] py-12" role="contentinfo">
    <div class="container-main">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="text-center md:text-left">
                <p class="font-semibold text-[var(--text-primary)]">{{ $portfolio['name'] }} © {{ date('Y') }}</p>
                <p class="text-sm text-[var(--text-muted)] mt-1">
                    Desarrollado con Laravel, Livewire y Tailwind CSS.
                </p>
            </div>
            ...
            <nav aria-label="Enlaces sociales">
                <ul class="flex items-center gap-4" role="list">
                    ...
                    <li>
                        <a href="{{ $portfolio['linkedin'] }}" target="_blank" rel="noopener noreferrer" class="social-link" aria-label="LinkedIn de {{ $portfolio['name'] }}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5" aria-hidden="true">
